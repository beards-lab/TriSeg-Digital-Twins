%% Script Summary:
% This script generates a video reflecting ventricular motion and its interaction with tension.
...
% Give the different layers different color based on the tension
minData = 0;
maxData = 500;
% Custom cmap
numColors = 256;
...
elseif exist("ModelWin",'var')
    v = VideoWriter(sprintf('Movies/P_NO%dWindow%d',PATIENT_NO,ModelWin), 'MPEG-4');
else
    v = VideoWriter(sprintf('UWMovies/P_NO%d',PATIENT_NO), 'MPEG-4');
end
