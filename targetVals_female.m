...
% mods = {'k_pas','k_act_LV','k_act_RV','C_SA','C_PA','R_SA','R_PA','R_atria','R_m_o','Vw_LV','Vw_SEP','Vw_RV','V_SV_s','LvSepR','V0c_coeff_LA','V0c_coeff_RA','V0c_coeff','R_tPA','R_tSA','K_P','B_P'};
