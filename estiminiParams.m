...
%% Activation Function
if isfield(inputData,'ActT')
k_TS = (inputData.ActT*HR/6e4)*2/3; % Beginning of cardiac cycle to maximal systole  
k_TR = (inputData.ActT*HR/6e4)*1/3; % Relaxation time fraction 
else
